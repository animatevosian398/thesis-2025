<template>
  ...
  >
    ...
    <div class="content-container">
      <h1 class="centered-title">Discussion About Denial</h1>
...
export default defineComponent({
  ...
  data() {
    return {
      comments: [],
      stanceColor: stanceColors["Discussion_About_Denial"] || "#f0f0f0",
      scrollInterval: null,
        ...
        complete: (results) => {
          this.comments = results.data
            .filter((row) => {
              ...
              return stance === "discussion_about_denial";
            })
            .map((row, index) => {
