<template>
  ...
  >
    ...
    <div class="content-container">
      <h1 class="centered-title">Reconciliation Discourse</h1>
...
export default defineComponent({
  ...
  data() {
    return {
      comments: [],
      stanceColor: stanceColors["Reconciliation_Discourse"] || "#f0f0f0",
      scrollInterval: null,
        ...
        complete: (results) => {
          this.comments = results.data
            .filter((row) => {
              ...
              return stance === "reconciliation_discourse";
            })
            .map((row, index) => {
              ...
              cleanedText = cleanedText
                ...
                .replace(/peace?/gi, "<b>$&</b>"); // Also bold "source" and "sources"
