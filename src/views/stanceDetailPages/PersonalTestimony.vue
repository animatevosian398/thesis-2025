<template>
  <div class="stance-page-container" :style="{ backgroundColor: stanceColor }">
    ...
    <div class="content-container">
      <h1 class="centered-title">Personal Testimony</h1>
...
export default defineComponent({
  ...
  data() {
    return {
      comments: [],
      stanceColor: stanceColors["Personal_Testimony"] || "#f0f0f0",
      scrollInterval: null,
        ...
        complete: (results) => {
          this.comments = results.data
            .filter((row) => {
              ...
              return stance === "personal_testimony";
            })
            .map((row) => {
          ...
          console.log("Filtered personal testimony comments:", this.comments);
          this.$nextTick(() => {
            this.startScrolling();
          });
        },
