<template>
  ...
  >
    ...
    <div class="content-container">
      <h1 class="centered-title">Debating Evidence</h1>
...
export default defineComponent({
  ...
  data() {
    return {
      comments: [],
      stanceColor:
        stanceColors["Procedural_Deflection_Evidence_Archives"] || "#f0f0f0",
      scrollInterval: null,
        ...
        complete: (results) => {
          this.comments = results.data
            .filter((row) => {
              ...
              return stance === "procedural_deflection_evidence_archives";
            })
            .map((row, index) => {
              ...
              // Bold words related to evidence and archives
              cleanedText = cleanedText
                // Original terms
                .replace(/sorry/gi, "<b>$&</b>")
                .replace(/apologize/gi, "<b>$&</b>")
                // Evidence-related terms
                .replace(/evidence/gi, "<b>$&</b>")
                .replace(/proof/gi, "<b>$&</b>")
                .replace(/archive[s]?/gi, "<b>$&</b>") // Match both "archive" and "archives"
                .replace(/document[s]?/gi, "<b>$&</b>") // Also bold "document" and "documents"
                .replace(/historian[s]?/gi, "<b>$&</b>") // Also bold "historian" and "historians"
                .replace(/research/gi, "<b>$&</b>")
                .replace(/source[s]?/gi, "<b>$&</b>"); // Also bold "source" and "sources"
          ...
          console.log(
            "Filtered Procedural Deflection comments:",
