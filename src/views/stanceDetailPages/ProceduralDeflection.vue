          ...
          this.comments = results.data
            ...
            .map((row) => {
              ...
              cleanedText = cleanedText
                .replace(/([.!?])([A-Z])/g, "$1 $2")
                .replace(/archives/gi, "<b>$&</b>")
                .replace(/evidence/gi, "<b>$&</b>")
                .replace(/proof/gi, "<b>$&</b>")
                .replace(/experts/gi, "<b>$&</b>")
                .replace(/library/gi, "<b>$&</b>")
                .replace(/libraries/gi, "<b>$&</b>")

                .replace(/historians/gi, "<b>$&</b>")
                .replace(/archive/gi, "<b>$&</b>");

              return cleanedText;
            });

          console.log("Filtered debating evidence comments:", this.comments);
          this.$nextTick(() => {
            this.startScrolling();
          });
        },
